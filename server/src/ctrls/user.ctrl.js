...
async function all(req, res) {
    try {
        const data = await User.find({ enabled: true, ...req.query }).populate('bureau').populate('direction').populate('tutelle');
...
export default {
    all, one, create, update, remove, login,deleteAll,findByTutelle
};