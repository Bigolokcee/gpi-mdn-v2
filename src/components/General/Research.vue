<template>
  <div>
   ...
   <!--  <Search /> -->
    <div class="field">
      <input type="text" @keydown.enter="test" v-model="letter" ref="autoCompleteInput" @keydown="loadAutocompleteData" placeholder="Type something....">
      <div v-if="!openBox">
