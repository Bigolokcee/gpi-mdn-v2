...
export default {
  ...
  methods: {
    ...
    selectedTutelle(value) {
      ...
      if (value != "") {
        this.filteredList = this.categories.filter( f => f.tutelle._id === value )
      } else {
    ...
    filterData(value) {
      this.filteredList = this.categories;
      this.filteredList = filtering(this.categories,value,this.filterOptions,this.currentTutelleValue)
