...
export default {
  ...
  methods: {
    ...
    selectedTutelle(value) {
      ...
      if (value != "") {
        this.filteredList = this.filteredList.filter( f => f.tutelle._id === value && ( ( f.libelle.toLowerCase().trim().includes(this.filterValue.toLowerCase().trim()) || f.code.toLowerCase().trim().includes(this.filterValue.toLowerCase().trim())) && f.tutelle._id.includes(this.currentTutelleValue)))
      } else {
        this.filteredList = this.directions
      }
    },
    filterData(value) {
      ...
      this.filteredList = this.filteredList.filter(
        (direction) => {
          ...
          return ( ( ( direction.libelle.toLowerCase().trim().includes(value.toLowerCase().trim()) || direction.code.toLowerCase().trim().includes(value.toLowerCase().trim() )) )) 
        }
      );
    },
